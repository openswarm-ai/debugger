...
const ColorPickerPopup = ({ color, onChange, onClose }) => {
...
const TreeNode = ({ node, nodeId, expanded, handleExpandClick, handleCheckboxChange, handleColorChange, handleEmojiChange, renderTree }) => {
    ...
    const handleRowClick = (e) => {
        ...
        if (e.target.closest('.node-checkbox, .picker-wrapper, .color-trigger')) return;
                    ...
                    <div className="color-trigger" onClick={e => e.stopPropagation()}>
                        ...
                        {showColorPicker && (
                            <ColorPickerPopup
                                ...
                                onChange={(color) => handleColorChange(nodeId, color)}
